		...
		<div class="sub_box" >
			...
			<div class="panel-body" >
				...
				<div class="form-group" >
					<div class="col-md-10 col-md-offset-1 ">
						<label>Address</label>
						<?php echo $this->Form->input('address', array( 'class' => 'form-control', 'placeholder' => 'User name', 'autofocus' => true, 'autocomplete' => 'off','label' => false)); ?>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-10 col-md-offset-1">
						...
						<?php echo $this->Form->input('confirm_password', array('placeholder' => 'password', 'autocomplete' => 'off','label' => false,'type'=>'password', 'class' => 'form-control')); ?>
					</div>
				</div>
