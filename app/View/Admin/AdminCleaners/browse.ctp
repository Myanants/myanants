	...
	<div class="x_content">
		<table class="table-st">
			<tbody>
				...
				<tr>
					<td class="left"> Job Type and Skill </td>
					<td class="right">
						<?php $arr = array(); ?>
						<?php if (!empty($data['Cleaner']['job_type'])) { ?>
							<?php
								$jobArr = explode('@@', $data['Cleaner']['job_type']) ;
							...
							?>
						<?php }	?>
						<?php foreach ($arr as $arrkey => $arrvalue) {
							echo $arrvalue[0] . ' ( '.$skill[$arrvalue[1]].' ) <br/>';
						} ?>
					</td>
				</tr>
